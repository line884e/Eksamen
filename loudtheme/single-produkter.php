        ...
        <article class="martin">
            <div class="wrapper">
                ...
                <div class="col2">
                    ...
                    <p class="pris"></p>
                    <p class="single_p"></p>
                    <button class="laeg_i_kurv">LÆG I KURV</button>
                </div>
            </div>
        </article>
...
<script>
    ...
    function visProdukter() {
        ...
        document.querySelector(".single_billede").src = produkt.billede.guid;
        document.querySelector(".beskrivelse_produkt").innerHTML = produkt.beskrivelse_produkt;
        document.querySelector(".single_p").innerHTML = produkt.single;
